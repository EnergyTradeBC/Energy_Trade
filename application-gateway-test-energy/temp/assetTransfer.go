...
func main() {
	...
	result, err := contract.SubmitTransaction("CreateAsset", "energy_1", "10")
	if err != nil {
	...
	result, err = contract.EvaluateTransaction("ReadAsset", "energy_1")
	if err != nil {
	...
	_, err = contract.SubmitTransaction("TransferAsset", "energy_1", "Tom", "5")
	if err != nil {
		log.Fatalf("Failed to Submit transaction: %v", err)
	}
