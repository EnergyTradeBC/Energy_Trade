...
func createAuction(contract *client.Contract, item string, price string, quantity string) {
	...
	_, err := contract.Submit("CreateAuction",
		client.WithArguments(auctionID, item, price, quantity))
...
func closeAuction(contract *client.Contract, bidID string) {
	fmt.Printf("\n--> Evaluate Transaction: get auction information \n")
